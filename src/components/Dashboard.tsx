    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-6">
        <Card className="bg-gradient-to-br from-white to-emerald-50/30 border border-emerald-100/50 shadow-sm p-4 sm:p-6 flex flex-col justify-between h-full hover:shadow-md transition-all">
          ...
          <div className="text-xl sm:text-2xl xl:text-3xl font-bold tracking-tighter text-emerald-950 whitespace-nowrap overflow-hidden text-ellipsis" title={formatCurrency(totalSpent)}>
        ...
        <Card className="bg-gradient-to-br from-white to-amber-50/30 border border-amber-100/50 shadow-sm p-4 sm:p-6 flex flex-col justify-between h-full hover:shadow-md transition-all">
          ...
          <div className={`text-xl sm:text-2xl xl:text-3xl font-bold tracking-tighter whitespace-nowrap overflow-hidden text-ellipsis ${caixaBalance > 0 ? 'text-emerald-700' : 'text-red-700'}`} title={formatCurrency(caixaBalance)}>
        ...
        <Card className="bg-gradient-to-br from-white to-red-50/30 border border-red-100/50 shadow-sm p-4 sm:p-6 flex flex-col justify-between h-full hover:shadow-md transition-all">
          ...
          <div className="text-xl sm:text-2xl xl:text-3xl font-bold tracking-tighter text-red-700 whitespace-nowrap overflow-hidden text-ellipsis" title={formatCurrency(terrenoBalance)}>
        ...
        <Card className="bg-gradient-to-br from-white to-purple-50/30 border border-purple-100/50 shadow-sm p-4 sm:p-6 flex flex-col justify-between h-full hover:shadow-md transition-all">
          ...
          <div className="text-xl sm:text-2xl xl:text-3xl font-bold tracking-tighter text-purple-950 whitespace-nowrap overflow-hidden text-ellipsis" title={formatCurrency(totalDonations)}>
